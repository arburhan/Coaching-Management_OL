            ...
            <div>
                <div className=" grid grid-rows:2 md:grid-cols-2 gap-12 items-center justify-center">
                    <div className='playerPosition'>
                        <figure>
                            <img className='rounded-2xl' src={aboutPlayerImage} alt="" />
                        </figure>
                    ...
                    <div className='px-12' >
                        <h1 className="text-4xl font-bold">তোমাকে জেতাতে পাশে আছে জিশান স্যার ও ফাহাদ স্যার-সহ শতশত মেন্টর</h1>
                        <p className="py-6">সবার জন্য মানসম্মত পড়াশোনা নিশ্চিতের মাধ্যমে শিক্ষা জীবনের প্রতিটি ধাপ জেতার জন্য রেডি করে তোলাই আমাদের লক্ষ্য</p>
                        <button className="btn btn-primary">আমাদের সম্পর্কে জেনে নাও</button>
                    </div>
                </div>
            </div>
        </div>
